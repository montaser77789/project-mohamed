...
HD_PWD='K:/Users/mohammed/Downloads/8_bit_computer/8_bit_computer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Computer_tp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Computer_tp.tcl
